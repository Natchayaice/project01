 ...
      <div class="w3-text-white w3-white w3-card-4">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-pale-black w3-margin-bottom">
        ...
        <h5 class="w3-opacity w3-black w3-center"><b>Favorite</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Mar 2017</h6>
          <p>color : pink and rainbows <br>
          food : Japanese Food <br>
          dessert : cake <br>
         </p>
          <hr>
        </div>
      ...
      <div style="background:url(55.jpeg)" class="w3-container w3-card-2">
