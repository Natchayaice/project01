...
<div class="w3-content w3-margin-top" style="max-width:1500px;">
 ...
      <div class="w3-text-white w3-black w3-card-4">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-pale-blue w3-margin-bottom">
      ...
      <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education</h2>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Information Systems</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jun 2015- 2019</h6>
