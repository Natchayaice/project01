...
<body img class="w3-image" src="22.jpg" alt="Architecture" width="1500" height="800" >
<!-- Page Container -->
<div class="w3-content w3-margin-top" style="max-width:1500px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-whiet w3-text-grey w3-card-4">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-whiet w3-margin-bottom">
        <h2 class="w3-text-whiet w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>About Me</h2>
        <div class="w3-container">
